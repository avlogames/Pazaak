...
import EnterRoomCode from "src/client/components/EnterRoomCode"
import wallpaper from "src/client/assets/images/wallpaper.jpg"
    ...
    <ImageBackground source={wallpaper} style={styles.imageBackground}>
      <KeyboardAvoidingView behavior={iOS ? "padding" : null} style={styles.container}>
        <View style={styles.wrapper}>
          <Image animation="bounceIn" style={styles.logo} source={require("src/client/assets/images/pazaak.png")} />
          <EnterRoomCode />
        </View>
