 ...
 */
export function initializeSideDeck(cards = []) {
 ...
 * Initialize Stack
 */
export function initializeStack(deal = false, stack = []) {
 ...
 */
export function sideDeckFloor(cards) {
 ...
 */
export function sideDeckCeiling(cards) {
  return cards.reduce((acc, { type, value }) => {
 ...
 */
export function stackLimit(stack) {
 ...
 */
export function smallestCombo(cards, currentScore, opponentScore) {
